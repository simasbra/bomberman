...
{
    /// <summary>
    /// Represents a Blue team player in the Bomberman game
    /// </summary>
    [Serializable]
    public class BluePlayer : Player
    {
        /// <summary>
        /// Initializes a new instance of the BluePlayer class
        /// </summary>
        ...
        public BluePlayer(byte lifes, int totalFrames, int frameWidth, int frameHeight, int caseligne, int casecolonne, int TileWidth, int TileHeight, int frameTime, byte playerNumero)
