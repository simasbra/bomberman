...
namespace BombermanMultiplayer.Commands
{
    ...
    public class DropGrenadeCommand : ICommand
    {
        ...
        /// </summary>
        public DropGrenadeCommand(Player player, TileContext[,] mapGrid, List<Grenade> grenadesOnTheMap, Player otherPlayer)
        {
        ...
        {
            return $"DropGrenadeCommand: Žaidėjas {PlayerNumber} numetė granatą pozicijoje [{_caseRow},{_caseCol}] - {Timestamp:HH:mm:ss.fff}";
        }
    }
}